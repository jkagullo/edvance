<?php
    ...
    $query = "SELECT students.first_name, students.last_name, students.email, users.username, users.password FROM students 
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['update_account'])) {
        ...
        $update_query = "UPDATE students 
                         INNER JOIN users ON students.user_id = users.id
                         SET students.first_name = '$first_name', students.last_name = '$last_name', 
                             students.email = '$email', users.username = '$username', users.password = '$password'
                         WHERE students.user_id = $user_id";
